# 🌤️ Hava Durumu Uygulaması (Vanilla JS)
...
- **Geolocation:** Tarayıcıdan konum izni alarak, uygulamanın "sen neredesin?" diye sormadan hava durumunu getirmesini sağladım.

## 🛠️ Teknik Detaylar
- **Dil:** HTML, CSS, JavaScript (ES6+)
- **Veri Kaynağı:** OpenWeatherMap API
- **Mantık:** Fetch API & Async-Await

## 🎨 Tasarım Hakkında
Tasarımı mümkün olduğunca sade tutmaya çalıştım. Mobilde de düzgün görünmesi için Flexbox ve Grid yapılarını kullandım.

---
**Geliştirmem için bir öneriniz var mı?** Benimle LinkedIn üzerinden iletişime geçebilirsiniz! 
www.linkedin.com/in/sıla-koç
